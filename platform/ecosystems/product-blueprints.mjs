...
export const PRODUCT_BLUEPRINTS = [
  ...
  {
    key: 'creator',
    label: 'Creator or portfolio',
    promise: 'Publish work, grow a following, sell directly, and stay connected to supporters.',
    defaultCapabilities: ['cms', 'community', 'directory'],
    optionalCapabilities: ['commerce', 'messaging', 'scheduling', 'crm', 'ai'],
    exampleAnswers: ['Sell my work', 'Grow my audience', 'Book collaborations'],
  },
  {
    key: 'nonprofit',
