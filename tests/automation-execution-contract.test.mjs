...
import { AUTOMATION_MODES, automationExecutionContract, automationIdempotencyKey, automationMode, needsAutomationApproval } from '../platform/automation/execution-contract.mjs'
