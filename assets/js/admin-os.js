...
(function () {
  ...
  function paintPlatformContracts(el, contracts, summary) {
    var rows = [
      ...
      ['Discovery and directory', platformSummaryCount(summary.discoverySurfaceCount, contracts.directoryDiscovery && contracts.directoryDiscovery.discoverySurfaces), 'Searchable people, organizations, communities, experiences, opportunities, visibility controls, ranking signals, and explanations.'],
      ...
      ['Places and maps', platformSummaryCount(summary.placeTypeCount, contracts.placesMaps && contracts.placesMaps.placeTypes), 'Reusable venues, booths, rooms, service areas, maps, floor plans, navigation, and place-based discovery.'],
      ['Content and CMS', platformSummaryCount(summary.contentTypeCount, contracts.contentCms && contracts.contentCms.contentTypes), 'Reusable pages, sections, media, navigation, announcements, revisions, publishing, and rollback controls.'],
      ...
      ['Advertising and sponsorship', platformSummaryCount(summary.advertisingOfferTypeCount, contracts.advertisingSponsorship && contracts.advertisingSponsorship.offerTypes), 'Transparent paid visibility, sponsor packages, campaigns, placements, creative review, delivery logs, and guardrails.'],
      ['Commerce and payments', platformSummaryCount(summary.commerceRecordTypeCount, contracts.commercePayments && contracts.commercePayments.recordTypes), 'Reusable orders, payments, refunds, invoices, ledger entries, provider references, reconciliation, and financial trust controls.'],
      ['Integrations and webhooks', platformSummaryCount(summary.integrationTypeCount, contracts.integrationsWebhooks && contracts.integrationsWebhooks.integrationTypes), 'Provider connections, inbound webhooks, outbound sync, credential references, retries, idempotency, and audit logs.'],
      ['Operations and audit', platformSummaryCount(summary.operationsRecordTypeCount, contracts.operationsAudit && contracts.operationsAudit.recordTypes), 'Reusable audit events, exports, incidents, readiness checks, rollback records, evidence, and operational trust controls.'],
