(function () {
  ...
  Promise.all([
    ...
    if(!items.length){var can=sources.filter(function(x){return x.id==='cannadispo'&&x.status==='available'})[0];host.innerHTML='<article class="community-post"><h3>Your story can start here.</h3><p>Share what you are building, what you need, or a win that can help somebody else.</p><a class="text-link" href="/feed">Create the first post -></a></article>'+(can?'<article class="community-post protected-post"><span class="origin-tag">Cannadispo · 18+</span><h3>Join our growing Cannadispo community.</h3><p>Enter the protected space to meet its members and read public community posts.</p><a class="text-link" href="/community/cannadispo">Confirm age and enter -></a></article>':'');return}
